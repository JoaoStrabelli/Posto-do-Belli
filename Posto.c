...
int main(){
    ...
    float valorCombustivel, valorTotal = 0, vendaTotal = 0, tanque = 200, litrosTotal = 0, maxCarros, quantAbastecida = 0;
    char escolha2;
    int escolha, carrosFila = 0, carrosAtendidos = 0, aux;
    ...
    while(aux != maxCarros || maxCarros <= 0){

        flush_in();

        printf(RED"\nValor invalido!"RESET);
        printf("\nInforme o tamanho da fila novamente: ");
        scanf("%f", &maxCarros);
